...
var semanticNetwork = new Dictionary<string, List<string>> {
    ...
    { "table",        new List<string>{ "kitchen", "chair", "dinner", "restaurant", "lamp", "dinner" } },
    ...
    { "sofa",         new List<string>{ "chair", "tv", "home", "couch" } },
    { "tv",           new List<string>{ "movie", "news", "internet", "sofa" } },
    { "movie",        new List<string>{ "tv", "video", "news", "sound" } },
    { "restaurant",   new List<string>{ "dinner", "food", "chef", "table", "market", "money", "coffee", "beer" } },
    { "dinner",       new List<string>{ "restaurant", "food", "kitchen", "table", "wine" } },
    ...
    { "park",         new List<string>{ "garden", "lake", "nature", "city", "walk" } },
    { "nature",       new List<string>{ "forest", "river", "tree", "mountain" } },
    ...
    { "bird",         new List<string>{ "animal", "cat", "song", "home" } },
    ...
    { "home",         new List<string>{ "house", "room", "garden", "chair", "village", "bird", "bear", "tea", "clean" } },
    { "apartment",    new List<string>{ "house", "home", "room", "building" } },
    { "room",         new List<string>{ "house", "home", "bed", "chair" } },
    { "bed",          new List<string>{ "room", "home", "couch", "mirror" } },
    { "couch",        new List<string>{ "sofa", "bed", "home", "room" } },
